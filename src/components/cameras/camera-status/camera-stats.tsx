...
<div className=" w-full h-full  p-2">
    <div className='bg-white w-full p-1'>
        <svg className="w-25 m-auto opacity-75" viewBox="0 0 146 146" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <h5 className="text-lg text-gray-600 text-center">Global Activities</h5>
                        <div className="mt-2 flex justify-center gap-4">
                            <h3 className="text-2xl font-bold text-gray-700">20%</h3>
...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                   ...
                   <div className='w-full text-center '>
                    <button className='bg-green-600 px-4 py-2 rounded-sm border-0 text-white m-1'>Show logs</button>
                    <button className='bg-red-600 px-4 py-2 rounded-sm border-0 text-white m-1' >Delete App</button>
